...
namespace nn {
Individual::Individual(const std::vector<int>& structure, const ActivationFunction& activation) : network(structure, activation) {}

void Individual::mutate(float mutationRate, float mutationStrength) {
